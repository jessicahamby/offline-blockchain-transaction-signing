...
export default function ColorToggleButton() {
    const [option, setOption] = React.useState('Generate');
    ...
    const Disclaimer = () => {
        return (
            <div style={{margin:10, flex: 1, justifyContent: 'center', alignItems: 'center', flexDirection:'column' }}>
                <p>This application is only compatible on Desktop Browser</p>
    ...
    if (!isDesktop()) {
        _redirect("https://github.com/realabbas")
        return <Disclaimer />
    }
